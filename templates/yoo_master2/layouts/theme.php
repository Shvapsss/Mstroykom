...
<body class="<?php echo $this['config']->get('body_classes'); ?>">
	...
	<div class="uk-container uk-container-center">
		...
		<div class="tm-footer-a-1">
		<?php if ($this['widgets']->count('footer-a')) : ?>
		<section class="<?php echo $grid_classes['footer-a']; echo $display_classes['footer-a']; ?>" data-uk-grid-match="{target:'> div > .uk-panel'}" data-uk-grid-margin><?php echo $this['widgets']->render('footer-a', array('layout'=>$this['config']->get('grid.footer-a.layout'))); ?></section>
		<?php endif; ?>
		</div>
