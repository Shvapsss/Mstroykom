...
if ($sidebar1 && $sidebar2) {
	$this->loadBlock('mainbody/two-sidebar-left-stroy', array('sidebar1' => $sidebar1, 'sidebar2' => $sidebar2, 'mastcol' => $mastcol));
	...
	$this->loadBlock('mainbody/one-sidebar-left-stroy', array('sidebar' => $sidebar1 ? $sidebar1 : $sidebar2));
} else {
